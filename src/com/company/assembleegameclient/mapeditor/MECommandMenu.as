...
public class MECommandMenu extends CommandMenu {
    ...
    public function MECommandMenu() {
        ...
        addCommandMenuItem("(B)ack", KeyCodes.B, this.onBack, NONE_COMMAND);
    }
    ...
    private function onBack(item:CommandMenuItem):void {
        dispatchEvent(new CommandEvent(CommandEvent.BACK_COMMAND_EVENT));
    }
}
}
