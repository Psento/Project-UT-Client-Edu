...
public class Player extends Character {
    ...
    public var maxSP_:int = 0;
    public var sp_:Number = 0;
    public var maxRP_:int = 200;
    public var rp_:Number = 0;
    public var nextLevelExp_:int = 1000;
    public var exp_:int = 0;
    public var awakening_:int = -1;
    public var relic_:int = -1;
    public var background_:int = -1;
    public var ascensionPoints_:int = 0;
    public var statPoints_:int = 0;
    ...
    public function Player(objectXML:XML) {
        ...
        this.armorMax_ = int(objectXML.Armor.@max);
        this.speedMax_ = int(objectXML.Speed.@max);
        this.dexterityMax_ = int(objectXML.Dexterity.@max);
        this.vigorMax_ = int(objectXML.HpRegen.@max);
        this.intelligenceMax_ = int(objectXML.MpRegen.@max);
    ...
    public static function fromPlayerXML(name:String, playerXML:XML):Player {
        ...
        player.awakening_ = int(playerXML.Awakening);
        player.relic_ = int(playerXML.Relic);
        ...
        player.sp_ = int(playerXML.ShieldPoints);
        player.maxRP_ = int(playerXML.MaxResourcePoints);
        player.rp_ = int(playerXML.ResourcePoints);
        player.attack_ = int(playerXML.Attack);
        player.armor_ = int(playerXML.Armor);
    ...
    public function useAltWeapon(x:Number, y:Number, slotId:int):Boolean {
        if (map_ == null) {
            return false;
        }
