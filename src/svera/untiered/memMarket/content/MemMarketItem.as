...
public class MemMarketItem extends Sprite
{
    ...
    private var itemLabel_:UILabel;
    ...
    {
        this.toolTip_ = new EquipmentToolTip(this.itemData, this.gameSprite_.map.player_);
    ...
    public function UpdateCounter():void
    {
        ...
        this.itemLabel_.filters = FilterUtil.getTextOutlineFilter();
    ...
    public function CreateLabel():void
    {
        ...
        {
            this.itemLabel_ = new UILabel();
            DefaultLabelFormat.tierLevelLabel(this.itemLabel_,12,16777215);
            this.tagContainer_.addChild(this.itemLabel_);
        }
